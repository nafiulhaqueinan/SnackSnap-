...
<body class="home">
        ...
        <div class="row">
        <h2>Get food fast &mdash; not fast food</h2>                                    <h2>Get food fast &mdash; not fast food</h2>
        
                
                <p class="long-copy">
                    Hello, we're SnackSnap-, your new premium food delivery service. We know you're always busy. No time for cooking. So let us take care of that, we're really good at it, we promise!
                </p>
            </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    ...
                    <p class="lead">Easiest way to order your favourite food among these top  dishes</p>
                </div>
                <div class="row">
						<?php 					
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                                    ...
                                    <h5>Phone: +8801711223344</a></h5> </div>
